...
namespace TelegramBot\Types\Settings;

/**
 * Class Settings
 * @package TelegramBot\Types\Settings
 */
class Settings
{
    /**
     ...
     */
    public function __construct(Sections\GeneralSection $general_section, Sections\TelegramSection $telegram_section, Sections\MaintenanceSection $maintenance_section, Sections\AntifloodSection $antiflood_section)
    {
