 ...
 * @package TelegramBot\Types\Settings\Sections
 */
class AntifloodSection implements SectionInterface
{
     ...
     */
    public function __construct(bool $enabled, int $messages_seconds, int $messages_number, int $ban_seconds, string $ban_message)
    {
